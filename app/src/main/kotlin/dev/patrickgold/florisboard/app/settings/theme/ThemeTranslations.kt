...
private val PropertyNameMap = mapOf(
    ...
    Snygg.Rotation to R.string.snygg__property_name__rotation,
    Snygg.TranslationX to R.string.snygg__property_name__translation_x,
    Snygg.TranslationY to R.string.snygg__property_name__translation_y,
    Snygg.TransitionDuration to R.string.snygg__property_name__transition_duration,
    Snygg.TransitionTimingFunction to R.string.snygg__property_name__transition_timing_function,
